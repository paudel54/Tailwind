        ...
        <div className="flex flex-col lg:flex-row  flex-center justify-center gap-3">
          ...
          <div className="w-full lg:w-1/2 mb-12 lg:mb-0">
            ...
            <div className="mt-8">
              ...
              <button className="mr-4 py-2 px-3 border-2 border-blue-400 font-semibold text-blue-400 shadow-md hover:bg-blue-400 hover:text-white rounded-full transition-all">
                <span className="flex gap-1 justify-center items-center">
                  <SiSololearn />
                  Learn...
                </span>
